...
-export([enum_symbol_by_value_TipoSubscricao/1, enum_value_by_symbol_TipoSubscricao/1]).
...
%% enumerated types
-type 'TipoMensagem'() :: 'LEILAO' | 'EMISSAO' | 'SUBSCRICAO' | 'AUTENTICACAO'.
...
-type 'Subscricao'() :: #'Subscricao'{}.

-export_type(['Autenticacao'/0, 'RespostaAutenticacao'/0, 'MensagemUtilizador'/0, 'MensagemEmpresa'/0, 'CriacaoLeilao'/0, 'EmissaoTaxaFixa'/0, 'MensagemInvestidor'/0, 'LicitacaoLeilao'/0, 'SubscricaoTaxaFixa'/0, 'RespostaExchange'/0, 'Resposta'/0, 'NotificacaoUltrapassado'/0, 'Resultado'/0, 'Subscricao'/0]).

-spec encode_msg(#'Autenticacao'{} | #'RespostaAutenticacao'{} | #'MensagemUtilizador'{} | #'MensagemEmpresa'{} | #'CriacaoLeilao'{} | #'EmissaoTaxaFixa'{} | #'MensagemInvestidor'{} | #'LicitacaoLeilao'{} | #'SubscricaoTaxaFixa'{} | #'RespostaExchange'{} | #'Resposta'{} | #'NotificacaoUltrapassado'{} | #'Resultado'{} | #'Subscricao'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'Autenticacao'{} | #'RespostaAutenticacao'{} | #'MensagemUtilizador'{} | #'MensagemEmpresa'{} | #'CriacaoLeilao'{} | #'EmissaoTaxaFixa'{} | #'MensagemInvestidor'{} | #'LicitacaoLeilao'{} | #'SubscricaoTaxaFixa'{} | #'RespostaExchange'{} | #'Resposta'{} | #'NotificacaoUltrapassado'{} | #'Resultado'{} | #'Subscricao'{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'Subscricao' ->
	  encode_msg_Subscricao(id(Msg, TrUserData), TrUserData)
    end.
...
encode_msg_RespostaAutenticacao(#'RespostaAutenticacao'{sucesso
    ...
    begin
      ...
      if TrF5 == [] -> B4;
	 true ->
	     e_field_RespostaAutenticacao_empresasSubscritas(TrF5,
							     B4, TrUserData)
      end
    end.
...
encode_msg_Subscricao(#'Subscricao'{tipo = F1,
				    eSubscricao = F2, empresa = F3},
		      Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_enum_TipoSubscricao(TrF1, <<Bin/binary, 8>>,
				 TrUserData)
	 end,
    B2 = begin
	   TrF2 = id(F2, TrUserData),
...
e_field_RespostaAutenticacao_empresasSubscritas([Elem
						 | Rest],
						Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 42>>,
    Bin3 = e_type_string(id(Elem, TrUserData), Bin2,
			 TrUserData),
    e_field_RespostaAutenticacao_empresasSubscritas(Rest,
						    Bin3, TrUserData);
e_field_RespostaAutenticacao_empresasSubscritas([], Bin,
						_TrUserData) ->
    Bin.
...
e_enum_TipoMensagem('SUBSCRICAO', Bin, _TrUserData) ->
    <<Bin/binary, 3>>;
e_enum_TipoMensagem('AUTENTICACAO', Bin, _TrUserData) ->
    <<Bin/binary, 4>>;
...
decode_msg_2_doit('Subscricao', Bin, TrUserData) ->
    id(decode_msg_Subscricao(Bin, TrUserData), TrUserData).
...
dfp_read_field_def_RespostaAutenticacao(<<18,
    ...
    d_field_RespostaAutenticacao_papel(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_RespostaAutenticacao(<<24,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData) ->
    d_field_RespostaAutenticacao_leilaoSubscrito(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 F@_5, TrUserData);
dfp_read_field_def_RespostaAutenticacao(<<32,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData) ->
    d_field_RespostaAutenticacao_emissaoSubscrita(Rest, Z1,
						  Z2, F@_1, F@_2, F@_3, F@_4,
						  F@_5, TrUserData);
dfp_read_field_def_RespostaAutenticacao(<<42,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					TrUserData) ->
    d_field_RespostaAutenticacao_empresasSubscritas(Rest,
...
dfp_read_field_def_RespostaAutenticacao(<<>>, 0, 0,
    ...
    #'RespostaAutenticacao'{sucesso = F@_1, papel = F@_2,
			    leilaoSubscrito = F@_3, emissaoSubscrita = F@_4,
			    empresasSubscritas = lists_reverse(R1, TrUserData)};
...
dg_read_field_def_RespostaAutenticacao(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_RespostaAutenticacao_papel(Rest, 0, 0, F@_1,
					     ...
					     TrUserData);
      24 ->
	  d_field_RespostaAutenticacao_leilaoSubscrito(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       F@_5, TrUserData);
      32 ->
	  d_field_RespostaAutenticacao_emissaoSubscrita(Rest, 0,
							0, F@_1, F@_2, F@_3,
							F@_4, F@_5, TrUserData);
      42 ->
	  d_field_RespostaAutenticacao_empresasSubscritas(Rest, 0,
							  0, F@_1, F@_2, F@_3,
							  F@_4, F@_5,
							  TrUserData);
      _ ->
...
d_field_RespostaAutenticacao_leilaoSubscrito(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     F@_5, TrUserData)
    when N < 57 ->
    d_field_RespostaAutenticacao_leilaoSubscrito(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, F@_5,
						 TrUserData);
d_field_RespostaAutenticacao_leilaoSubscrito(<<0:1, X:7,
					       Rest/binary>>,
...
d_field_RespostaAutenticacao_emissaoSubscrita(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3, F@_4,
					      F@_5, TrUserData)
    when N < 57 ->
    d_field_RespostaAutenticacao_emissaoSubscrita(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, F@_3, F@_4, F@_5,
						  TrUserData);
d_field_RespostaAutenticacao_emissaoSubscrita(<<0:1,
						X:7, Rest/binary>>,
...
d_field_RespostaAutenticacao_empresasSubscritas(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, F@_2, F@_3, F@_4,
						F@_5, TrUserData)
    when N < 57 ->
    d_field_RespostaAutenticacao_empresasSubscritas(Rest,
						    ...
						    F@_2, F@_3, F@_4, F@_5,
						    TrUserData);
d_field_RespostaAutenticacao_empresasSubscritas(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, F@_2, F@_3, F@_4,
						Prev, TrUserData) ->
    {NewFValue, RestF} = begin
...
dfp_read_field_def_Subscricao(<<8, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Subscricao_tipo(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			    TrUserData);
dfp_read_field_def_Subscricao(<<16, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Subscricao_eSubscricao(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, TrUserData);
dfp_read_field_def_Subscricao(<<26, Rest/binary>>, Z1,
			      Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Subscricao_empresa(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData);
dfp_read_field_def_Subscricao(<<>>, 0, 0, F@_1, F@_2,
			      F@_3, _) ->
    #'Subscricao'{tipo = F@_1, eSubscricao = F@_2,
		  empresa = F@_3};
dfp_read_field_def_Subscricao(Other, Z1, Z2, F@_1, F@_2,
			      F@_3, TrUserData) ->
    dg_read_field_def_Subscricao(Other, Z1, Z2, F@_1, F@_2,
				 F@_3, TrUserData).

dg_read_field_def_Subscricao(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_Subscricao(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, TrUserData);
dg_read_field_def_Subscricao(<<0:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_Subscricao_tipo(Rest, 0, 0, F@_1, F@_2, F@_3,
				  TrUserData);
      16 ->
	  d_field_Subscricao_eSubscricao(Rest, 0, 0, F@_1, F@_2,
					 F@_3, TrUserData);
      26 ->
	  d_field_Subscricao_empresa(Rest, 0, 0, F@_1, F@_2, F@_3,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_Subscricao(Rest, 0, 0, F@_1, F@_2, F@_3,
				       TrUserData);
	    1 ->
		skip_64_Subscricao(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
	    2 ->
		skip_length_delimited_Subscricao(Rest, 0, 0, F@_1, F@_2,
						 F@_3, TrUserData);
	    3 ->
		skip_group_Subscricao(Rest, Key bsr 3, 0, F@_1, F@_2,
				      F@_3, TrUserData);
	    5 ->
		skip_32_Subscricao(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData)
	  end
    end;
dg_read_field_def_Subscricao(<<>>, 0, 0, F@_1, F@_2,
			     F@_3, _) ->
    #'Subscricao'{tipo = F@_1, eSubscricao = F@_2,
		  empresa = F@_3}.

d_field_Subscricao_tipo(<<1:1, X:7, Rest/binary>>, N,
			Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_Subscricao_tipo(Rest, N + 7, X bsl N + Acc,
			    F@_1, F@_2, F@_3, TrUserData);
d_field_Subscricao_tipo(<<0:1, X:7, Rest/binary>>, N,
			Acc, _, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} = {id(d_enum_TipoSubscricao(begin
						     <<Res:32/signed-native>> =
							 <<(X bsl N +
							      Acc):32/unsigned-native>>,
						     id(Res, TrUserData)
			     ...
			     TrUserData),
			  Rest},
    dfp_read_field_def_Subscricao(RestF, 0, 0, NewFValue,
				  F@_2, F@_3, TrUserData).

d_field_Subscricao_eSubscricao(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_Subscricao_eSubscricao(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
d_field_Subscricao_eSubscricao(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, _, F@_3, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_Subscricao(RestF, 0, 0, F@_1,
				  NewFValue, F@_3, TrUserData).

d_field_Subscricao_empresa(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_Subscricao_empresa(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, TrUserData);
d_field_Subscricao_empresa(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_Subscricao(RestF, 0, 0, F@_1, F@_2,
				  NewFValue, TrUserData).

skip_varint_Subscricao(<<1:1, _:7, Rest/binary>>, Z1,
		       Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_Subscricao(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			   TrUserData);
skip_varint_Subscricao(<<0:1, _:7, Rest/binary>>, Z1,
		       Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_Subscricao(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData).

skip_length_delimited_Subscricao(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_Subscricao(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3,
				     TrUserData);
skip_length_delimited_Subscricao(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_Subscricao(Rest2, 0, 0, F@_1, F@_2,
				  F@_3, TrUserData).

skip_group_Subscricao(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_Subscricao(Rest, 0, Z2, F@_1, F@_2,
				  F@_3, TrUserData).

skip_32_Subscricao(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
		   F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_Subscricao(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData).

skip_64_Subscricao(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
		   F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_Subscricao(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData).
...
d_enum_TipoMensagem(4) -> 'AUTENTICACAO';
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'Subscricao' ->
	  merge_msg_Subscricao(Prev, New, TrUserData)
    end.
...
merge_msg_RespostaAutenticacao(#'RespostaAutenticacao'{papel
    ...
    #'RespostaAutenticacao'{sucesso = NFsucesso,
			    ...
			    leilaoSubscrito =
				if NFleilaoSubscrito =:= undefined ->
				       PFleilaoSubscrito;
				   true -> NFleilaoSubscrito
				end,
			    emissaoSubscrita =
				if NFemissaoSubscrita =:= undefined ->
				       PFemissaoSubscrita;
				   true -> NFemissaoSubscrita
				end,
			    empresasSubscritas =
				if PFempresasSubscritas /= undefined,
				   NFempresasSubscritas /= undefined ->
				       'erlang_++'(PFempresasSubscritas,
						   NFempresasSubscritas,
						   TrUserData);
				   PFempresasSubscritas == undefined ->
				       NFempresasSubscritas;
				   NFempresasSubscritas == undefined ->
				       PFempresasSubscritas
				end}.
...
merge_msg_Subscricao(#'Subscricao'{empresa = PFempresa},
		     #'Subscricao'{tipo = NFtipo,
				   eSubscricao = NFeSubscricao,
				   empresa = NFempresa},
		     _) ->
    #'Subscricao'{tipo = NFtipo,
		  eSubscricao = NFeSubscricao,
		  empresa =
		      if NFempresa =:= undefined -> PFempresa;
			 true -> NFempresa
		      end}.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'Subscricao' ->
	  v_msg_Subscricao(Msg, [MsgName], TrUserData);
...
v_msg_RespostaAutenticacao(#'RespostaAutenticacao'{sucesso
    ...
    if F3 == undefined -> ok;
       true ->
	   v_type_bool(F3, [leilaoSubscrito | Path], TrUserData)
    end,
    if F4 == undefined -> ok;
       true ->
	   v_type_bool(F4, [emissaoSubscrita | Path], TrUserData)
    end,
    if is_list(F5) ->
	   _ = [v_type_string(Elem, [empresasSubscritas | Path],
			      TrUserData)
		|| Elem <- F5],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, string}, F5,
			 [empresasSubscritas | Path])
    end,
    ok;
...
-compile({nowarn_unused_function,v_msg_Subscricao/3}).
-dialyzer({nowarn_function,v_msg_Subscricao/3}).
v_msg_Subscricao(#'Subscricao'{tipo = F1,
			       eSubscricao = F2, empresa = F3},
		 Path, TrUserData) ->
    v_enum_TipoSubscricao(F1, [tipo | Path], TrUserData),
    v_type_bool(F2, [eSubscricao | Path], TrUserData),
    if F3 == undefined -> ok;
       true -> v_type_string(F3, [empresa | Path], TrUserData)
    end,
    ok;
v_msg_Subscricao(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'Subscricao'}, X, Path).
...
v_enum_TipoMensagem('SUBSCRICAO', _Path, _TrUserData) ->
    ok;
v_enum_TipoMensagem('AUTENTICACAO', _Path,
		    _TrUserData) ->
    ok;
...
v_enum_TipoSubscricao(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
v_enum_TipoSubscricao(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'TipoSubscricao'}, X,
		  Path).
    ...
    [{{enum, 'TipoMensagem'},
     ...
     {{msg, 'RespostaAutenticacao'},
      [#field{name = sucesso, fnum = 1, rnum = 2, type = bool,
       ...
       #field{name = leilaoSubscrito, fnum = 3, rnum = 4,
	      type = bool, occurrence = optional, opts = []},
       #field{name = emissaoSubscrita, fnum = 4, rnum = 5,
	      type = bool, occurrence = optional, opts = []},
       #field{name = empresasSubscritas, fnum = 5, rnum = 6,
...
get_msg_names() ->
    ['Autenticacao', 'RespostaAutenticacao',
     ...
     'NotificacaoUltrapassado', 'Resultado', 'Subscricao'].
...
enum_symbol_by_value('TipoSubscricao', Value) ->
    enum_symbol_by_value_TipoSubscricao(Value).
...
enum_value_by_symbol('TipoSubscricao', Sym) ->
    enum_value_by_symbol_TipoSubscricao(Sym).
...
enum_symbol_by_value_TipoMensagem(4) -> 'AUTENTICACAO'.
...
enum_value_by_symbol_TipoMensagem('AUTENTICACAO') -> 4.

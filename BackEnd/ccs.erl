...
-export_type(['Autenticacao'/0, 'RespostaAutenticacao'/0]).

-spec encode_msg(#'Autenticacao'{} | #'RespostaAutenticacao'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'Autenticacao'{} | #'RespostaAutenticacao'{}, atom() | list()) -> binary().
